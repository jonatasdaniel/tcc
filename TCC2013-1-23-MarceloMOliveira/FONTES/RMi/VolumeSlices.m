...
//esta constante nao esta sendo usada neste momento.
//ela pode ser utilizada futuramente
//o objetivo de sua criacao e determinar o tamanho maximo que as imagens geradas terao
int NUM_MAX_ROWS_COLUNS = 256;
//determina a quantidade de fatias que serao geradas
//no exame do joelho esse maximo e 40, mais que isto causa problema com gasto excessivo de memoria
int NUM_GENERATE_SLICES = 40;
//esta constante foi obtida atraves de testes para que fosse possivel ajustar
//uma imagem gerada quando o exame nao possui uma quantidade proxima a do tamanho da imagem
int VAR_ADJUST = 8;

@interface VolumeSlices ()
{
    //guarda a orientacao da primeira fatia
    GLint firstOrientation;
    //orientacao das imagens do volume sendo visualizado ou fatiado
...
/*
 Esta classe modela o volume para poder ser realizada a visualizacao volumetrica do exame medico.
 A visualzacao 3D e feita utilizado as proprias imagens como textura das fatias que formam o volume.
 */
@implementation VolumeSlices

/*
Os tres conjuntos de imagens. Um com as imagens obtidas dos arquivos, na direcao em que o exame foi feito 
 e os outros dois de imagens geradas.
 */
...
/*
 Informacoes obtidas de algumas tags que sao importantes para a visualizacao volumetrica
 */
...
-(void)generateOtherDirection {
    ...
    //estes metodos que geram as imagens nas 3 direcoes possuem alguns trechos de codigos repetidos.
    //ainda nao foi possivel refatorar o codigo para uma melhor legibilidade
    if(firstOrientation == SLICE_ORIENTATION_AXIAL && axialCount > 0) {
        ...
        //neste caso esta ocorrendo um problema com acesso a memoria
...
-(void)generateVoxels {
    ...
    //Esta parte foi utilizada em alguns testes para a realizar a visualizacao atraves de voxels.
    //Os testes foram iniciais e nao evoluiram ate entao. Pode ser utilizado numa futura implementacao do
    //raycasting.
    /*
