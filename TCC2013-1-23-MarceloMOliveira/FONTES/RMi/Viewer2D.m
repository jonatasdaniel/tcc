...
/*
 este metodo le todas as imagens novamente. Ocorreram alguns problemas na tentativa de obter 
 as imagens com 4 canais. Deve ser tratado este problema para que nao seja necessario fazer esta
 segunda leitura dos arquivos.
 */
-(void)loadImages {
