...
- (void)setupGL
{
    ...
    /*
     Testes feitos com o OpenGL ES. O objetivo era ver as diferentes formas de trabalhar com transparencia dos pixels,
     trabalhar com o canal alfa.
     */
...
- (void)fileListWillClose:(FileListViewController *)fileList
{
    ...
    if (ok) {
        ...
        if([self isDicomDir: self.fileToLoad]) {
            ...
            /*
             Testes feitos na visualizacao utilizando voxels estao comentados
             */
...
/*
 Este metodo e utilizado para verificar se ha algum arquivo dentro do diretorio que nao e DICOM
 */
...
/*
 Este metodo obtem os arquivos DICOM do diretorio selecionado pelo o usuario.
 */
...
/*
 Seleciona a orientacao do fatiamento.
 */
