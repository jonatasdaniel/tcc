 ...
 *
 */
public class PatientTableModel extends AbstractTableModel implements DicomTableModel{

	private static final long serialVersionUID = 1L;

	private String[] columns = {Translatrix.getTranslationString("dicom.PatientName"), Translatrix.getTranslationString("dicom.PatientID")};
	private Vector<DicomObject> patients = new Vector<DicomObject>();
